...
> # I'll need to update these images!! {.unnumbered }
...
1. Download the <i class="bi bi-download"></i> [ pirate-photos.zip](pirate-photos.zip){download="pirate-photos.zip"} file.
2. Expand the folder and take the images inside and put them inside your `src/img/` folder.
