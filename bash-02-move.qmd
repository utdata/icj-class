...
Both Macs and PCs have a `Documents` folder inside each user's home folder. It's where you are supposed to save all your stuff. It's time for us to move in our Terminal to inside this Documents folder.

The [cd](https://man.cx/cd) command lets us **change directory**.
...
4. Now you can do an `ls` on icj folder to see what is inside it.
