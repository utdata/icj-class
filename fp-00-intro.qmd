...
- A collection of photos in the <i class="bi bi-download"></i> [img-queen.zip](img-queen.zip){download="img-queen.zip"} archive. There are three collections of photos you'll want to put in the `src/img` folder:
  - Band photos
  - Band members
  - Album covers
...
- A collection of photos in <i class="bi bi-download"></i> [img-austin.zip](img-austin.zip){download="img-austin.zip"} archive. There are three collections of photos you'll want to put in the `src/img` folder:
