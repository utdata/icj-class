...
If you don't already have your project open in you Codespace VS Code, go ahead and open it. If you haven't already, run `$ gulp dev` in your terminal to start the development environment.
...
1. After you make the change above, make sure the styles are still building correctly and nothing broke on your page.
