...
You need to create a new project folder like you did in our last couple of chapters [Project setup](../git/git-01-project.qmd) and [Using Git](../git/git-02-cycle.qmd) but applied to this new project.
