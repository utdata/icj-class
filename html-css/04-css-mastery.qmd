...
::: callout-tip
You will likely find it useful to refer to the [CSS practice chapter](03-css-practice.qmd) as you work through this. 
:::
...
- Use [Google Fonts](https://fonts.google.com/) to find and use a font called "Ubuntu" and add that to your page. You can review the chapter [Using Google Fonts](../appendices/a-google-fonts.qmd) for tips on how.
