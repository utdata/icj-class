...
I may take a minute here in class to talk about iCloud and One Drive and how files are dealt with by cloud-based servers. I'm still working out the best way to write about it and talking to students will help me figure that out. We'll do it here because it may impact where we create the `icj/` folder.
::: 
