...
1. Give your new repo a name, like `yourname-codespace`.
1. Leave the other defaults as they are, and click green ***Create repository** button.
    - You'll get to the usual page we get after creating a new repository. However, notice no the big box on that page that says **Start coding with Codespaces**.
    - Click on the button **Create a codespace**.
1. You'll get yet another screen noting a README will be created when the codespace is created. Click on the **Create new codespace** button.
