...
::: callout-warning
If you had problems with `gulp fetch` before and went through [these steps](../appendices/a-fetch-problems.qmd) then you already have the data and can move on. But do reach out to me so we can fix it.
:::
