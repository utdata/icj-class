...
While this rig will work with JSON data as-is, there is a bit of extra setup and effort to use `gulp fetch` as described below. See [ICJ Setting Up Part 2: Google Auth](https://utdata.github.io/icj-setting-up/setup-part-2.html) for directions on how to set up access to Google's APIs.

:::

While in the Setting Up Part 2 chapter we set up a connection between Github and Google's APIs, we have to add our new repo to that access.
