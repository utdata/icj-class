...
2. create a new file `index.njk` in the same folder and insert the following code:
...
This would be a great time to pause and use the git cycle to commit your work to Github.
